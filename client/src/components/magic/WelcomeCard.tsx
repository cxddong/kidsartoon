                        ...
                        <div className="bg-white rounded-3xl p-8 text-center space-y-6">
                            ...
                            <div className="space-y-3">
                                <p className="text-slate-700 font-semibold">
                                    Master, you caught me! 🙀<br />
                                    Show me your drawing, and tell me to:
                                </p>
                                ...
                                <div className="space-y-2">
                                    <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-xl">
                                        ...
                                        <div className="text-left">
                                            <div className="font-bold text-blue-900">Animate It</div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3 p-3 bg-green-50 rounded-xl">
                                        ...
                                        <div className="text-left">
                                            <div className="font-bold text-green-900">Create Story</div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3 p-3 bg-purple-50 rounded-xl">
                                        ...
                                        <div className="text-left">
                                            <div className="font-bold text-purple-900">Comicify</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
