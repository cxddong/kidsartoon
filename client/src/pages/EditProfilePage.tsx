...
const EditProfilePage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        // Load init state from Context (sync'd)
        setName(user.name || '');
                ...
                <div className="p-8 space-y-6">
                    ...
                    <div className="pt-6 flex gap-4">
                        ...
                        <button
                            onClick={handleSave}
                            disabled={isSaving}
                            className="flex-1 py-3 bg-blue-500 text-white rounded-xl font-bold shadow-lg hover:bg-blue-600 transition-all flex items-center justify-center gap-2"
                        >
