        ...
        <div className="min-h-screen w-full bg-[#F8FAFC] font-sans pb-24 pt-safe relative custom-scrollbar flex flex-col">
            ...
            <div className="max-w-2xl mx-auto px-4 mt-20 space-y-12 relative z-10">
                ...
                <section className="space-y-6">
                    ...
                    <div className="flex gap-4 items-start">
                        ...
                        <div className="flex-1 space-y-3">
                            ...
                            <div className="relative aspect-[3/2] bg-white/20 backdrop-blur-md rounded-3xl border-4 border-dashed border-slate-200 hover:border-blue-400 transition-colors group overflow-hidden shadow-sm">
                                {drawing ? (
                                    <>
                        ...
                        <div className="w-1/3 space-y-3">
                            ...
                            <div className="relative aspect-square bg-white/20 backdrop-blur-md rounded-[2rem] border-4 border-dashed border-slate-200 hover:border-pink-400 transition-colors overflow-hidden group shadow-sm">
                                {photo ? (
                                    <>
                                        ...
                                        <button
                                            onClick={() => {
                                                setPhoto(null);
                                                // setShouldFuse(false); // Deprecated
                                            }}
                    ...
                    {/* NEW: Selfie Upgrade Section */}
                    {photo && (
                        <div className="space-y-4 animate-in fade-in slide-in-from-top-4 bg-purple-50 p-4 rounded-3xl border border-purple-100">

                            {/* A. Fun Filters */}
                            <div className="space-y-2">
                                <label className="text-xs font-bold text-purple-400 uppercase tracking-widest">Selfie Filter</label>
                                <div className="flex gap-2">
                                    {FILTERS.map(f => (
                                        <button
                                            key={f.id}
                                            ...
                                            className={cn(
                                                "flex-1 py-2 rounded-xl text-xs font-bold border transition-all flex flex-col items-center gap-1",
                            ...
                            {/* B. Composition Mode */}
                            <div className="space-y-2">
                                <label className="text-xs font-bold text-purple-400 uppercase tracking-widest">Composition</label>
                                <div className="grid grid-cols-2 gap-3">
                                    {COMPOSITION_MODES.map(mode => (
                                        <button
                                            ...
                                            className={cn(
                                                "p-3 rounded-2xl border-2 transition-all flex items-center gap-3 text-left",
                                                compositionMode.id === mode.id
                                                    ? "border-purple-600 bg-white shadow-md ring-2 ring-purple-100"
                                                    : "border-transparent bg-white/50 hover:bg-white"
                                            )}
                                        >
                                            <div className={cn("w-10 h-10 rounded-full flex items-center justify-center text-xl", compositionMode.id === mode.id ? "bg-purple-100" : "bg-slate-100")}>
                                                {mode.icon}
                                            </div>
                                            <div>
                                                <div className="font-bold text-sm text-slate-800">{mode.label}</div>
                            ...
                            {/* C. Role Selection (Only for Magic Mix) */}
                            {compositionMode.id === 'magic_mix' && (
                                    ...
                                    <div className="flex gap-2 flex-wrap">
                                        {SELFIE_ROLES.map(role => (
                                            <button
                                                ...
                                                className={cn(
                                                    "px-3 py-1.5 rounded-full font-bold text-xs border transition-all flex items-center gap-1",
                ...
                <section className="space-y-6">
                            ...
                            {occasions.map(occ => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={cn(
                                            "px-3 py-2 rounded-xl font-bold text-sm border transition-all text-center relative overflow-hidden",
                                            selectedOccasion.id === occ.id
                                                ? (isSeasonal ? "bg-red-500 text-white border-red-500 shadow-md ring-2 ring-red-200" : "bg-pink-500 text-white border-pink-500 shadow-md")
                                                : "bg-white text-slate-600 border-slate-200 hover:border-slate-400"
                                        )}
                                    >
                                        {isSeasonal && <span className="absolute -top-1 -right-1 flex h-3 w-3"><span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-yellow-400 opacity-75"></span><span className="relative inline-flex rounded-full h-3 w-3 bg-yellow-500"></span></span>}
                                        {occ.label}
                                    </button>
                                );
                            })}
                        ...
                        <div className="flex gap-3 overflow-x-auto pb-4 scrollbar-hide snap-x">
                            {ART_STYLES.map(style => (
                                <button
                                    ...
                                    className={cn(
                                        "min-w-[120px] aspect-square p-4 rounded-2xl border-2 transition-all flex flex-col items-center justify-center gap-2 snap-center",
                                        selectedStyle.id === style.id ? "border-slate-900 shadow-md bg-white" : "border-transparent bg-white shadow-sm"
                                    )}
                                >
                    ...
                    <div className="space-y-6 bg-white/50 p-4 rounded-2xl border border-slate-100">
                        {/* A. Frame */}
                        <div className="space-y-2">
                            ...
                            <div className="flex gap-2 flex-wrap">
                                {CARD_FRAMES.map(frame => (
                                    <button
                                        ...
                                        className={cn(
                                            "px-3 py-1.5 rounded-lg font-bold text-xs border transition-all",
                                            selectedFrame.id === frame.id ? "bg-slate-800 text-white border-slate-800" : "bg-white text-slate-600 border-slate-200 hover:border-slate-300"
                                        )}
                                    >
                                        {frame.label}
                                    </button>
                                ...
                                {STICKERS.map(sticker => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={cn(
                                                "px-3 py-1.5 rounded-lg font-bold text-xs border transition-all",
                                                isSelected ? "bg-purple-600 text-white border-purple-600" : "bg-white text-slate-600 border-slate-200 hover:border-slate-300"
                                            )}
                                        >
                                            {sticker.label}
                                        </button>
                            ...
                            <div className="flex gap-2 flex-wrap">
                                {TEXT_STYLES.map(style => (
                                    <button
                                        ...
                                        className={cn(
                                            "px-3 py-1.5 rounded-lg font-bold text-xs border transition-all",
                                            selectedTextStyle.id === style.id ? "bg-blue-600 text-white border-blue-600" : "bg-white text-slate-600 border-slate-200 hover:border-slate-300"
                                        )}
                                    >
                                        {style.label}
                                    </button>
                            ...
                            {RECIPIENTS.map(rec => (
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        recipientSelection === rec.id ? "bg-blue-100 text-blue-700 border-blue-200" : "bg-white text-slate-500 border-slate-200"
                                    )}
                                >
                                    {rec.label}
                                </button>
